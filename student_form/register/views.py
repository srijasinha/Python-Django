...
from register.models import Register_Db
...
def submit_form(request):
    if request.method == 'POST':
        ...
        Register_Db(First_Name=First_Name,
                    Middle_Name=Middle_Name, Last_Name=Last_Name,
                    Phone_Number=Phone_Number,College_Name=College_Name,
                    Home_Address=Home_Address, Gender=Gender,
                    Area_Of_Intrest=AOI).save()
